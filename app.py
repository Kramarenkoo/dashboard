...
SIDEBAR_STYLE = {
    ...
    "width": "20rem",
    "padding": "2rem 1rem",
    "background-color": "#D8BFD8", # Цвет фона боковой панели меняем на тот, который больше всего подходит
}
...
sidebar = html.Div(
    [
        ...
        html.Hr(),
        html.P(
            "Учебный проект студента", className="lead"
        ),
         html.P(
            "группы БСБО-15-21", className="lead"
        ),
        html.P(
            "Крамаренко А.Д.", className="lead"
        ),
        html.Hr(),
        dbc.Nav(
            [
